package com.smartwebarts.apnamart;
...
public class PayUMoneyActivity extends AppCompatActivity {
     ...
     */
    int mId;
    private String mMerchantKey = "yTOWuYWl";//For merchant and salt key you need to contact payu money tech support otherwise you get error
    private String mSalt = "IRCWifbIDX";//copy and paste works fine
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            mAmount = Double.parseDouble(bundle.getString("amount", "0"));//in my case amount getting as String so i parse it double
...
//            mAction = mBaseURL;
            ...
            webView.addJavascriptInterface(new PayUJavaScriptInterface(com.smartwebarts.apnamart.PayUMoneyActivity.this), "PayUMoney");
    ...
    public ProgressDialog showProgress(Context context) {
        if (getApplicationContext() != null && !isFinishing()) {
            ...
            View layout = mInflater.inflate(R.layout.default_progress_dialog, null);
