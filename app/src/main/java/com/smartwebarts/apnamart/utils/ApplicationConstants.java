package com.smartwebarts.apnamart.utils;
...
public enum ApplicationConstants {
    ...
    public String BASE_URL = "file:///android_asset/";

    public String SITE_URL = "http://apnamartonline.com/";
    ...
    public String PRIVACY_POLICY = SITE_URL + "apppages/privacypolicy.php";
    public String REFUND_POLICY = SITE_URL + "/apppages/refund.php";
    public String LIVE_CHAT = "https://tawk.to/chat/5f2537734f3c7f1c910d9d6b/default";
    public String FAQ = SITE_URL + "apppages/faq.php";

    public String FACEBOOK = "https://www.facebook.com/";
    public String INSTAGRAM = "https://www.instagram.com/";
    public String TWITTER = "https://mobile.twitter.com/";
